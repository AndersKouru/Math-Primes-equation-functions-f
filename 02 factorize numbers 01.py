...
def primeFactor(prim_tal):
        ...
        end_spar = 1
        end_spar = int(end)
        #print("end = ",end_spar," could save time!")
        ...
        print("factorizing !         ")
        print("")
        print("Number ",prim_spar," factorizes! ")
        prim_tal = prim_spar
        while divisor <= prim_tal and prim_tal > 2:  # try end in stead of prim_tal
            rest = prim_tal/divisor
            test = floor(rest)
            while rest == test and prim_tal >= divisor:# try end ii stead of divisor
                prim_tal = rest
                rest = (prim_tal/divisor) # Let us see how many times
