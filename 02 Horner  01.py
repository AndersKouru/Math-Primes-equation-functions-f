...
MAX_EQUATION = int(5)
MAX_TRYS    = int(20000)                 # Max_Trys was int(300)
...
def find_start(ekv_z,degree,start2,y_noll):
    ...
    if degree == 2 or degree == 3 or degree == 4 or degree == 5:
        ...
        if degree == 3:
            ...
            h_noll = -(z_noll/z_prim)
            h_noll *= 0.0100     #  Here you can change the sensitivity of the algorithm!
                               # h_noll should actually be = 1.0   (0.05) = latest value                
            y_ett  = h_noll + y_noll
            y_noll = y_ett
        ...
        if degree == 4:
            ...
            ftal3  = num_1 * ftal
            num_2  += ftal3   # second degrees term 
            ftal2  = num_2 * ftal
            num_3  += ftal2   # first degreesterm should be done = z_prim

            num_1  += ftal    # third degrees term should be done!
        ...
        if degree == 5:
            ...
            num_1  += ftal
            ftal3  = num_2 * ftal
            num_3  += ftal3   # second degrees term should soon be done!

            ftal2  = num_3 * ftal
            num_4  += ftal2   # first degrees term should soon be done!
            ftal2  = num_4 * ftal
            num_5  += ftal2   # constant term should be done! = z_noll

            ftal3  = num_1 * ftal
            num_2  += ftal3   
            ftal2  = num_2 * ftal
            num_3  += ftal2   # second degree term should be done
...
def find_z(ekv_z,copy,degree,start):
    ...
    if degree == 2 or degree == 3 or degree == 4 or degree == 5:
        ...
        if degree == 4:
            ...
            ftal3  = num_3 * ftal
            num_4  += ftal3   # constant term is done!
            ftal3  = num_1 * ftal
            num_2  += ftal3   
            ftal2  = num_2 * ftal
            num_3  += ftal2   # first degree term is done! 

            num_1  += ftal  
            ftal2  = num_1 * ftal
            num_2  += ftal2   # second degrees term is done! 

            num_1  += ftal    # third degree term is done! 
        ...
        if degree == 5:
            ...
            num_1 += ftal   
            ftal2  = num_1 * ftal
            num_2 += ftal2   # third degrees term

            num_1  += ftal
            ftal3  = num_2 * ftal
            num_3  += ftal3
            ftal3  = num_3 * ftal
            num_4  += ftal3          # first degree term is soon done!
            
            ftal3  = num_4 * ftal
            num_5  += ftal3          # constant term is done!
            ...
            num_3  += ftal3           
            ftal3  = num_3 * ftal
            num_4  += ftal3           # firstdegree term is done!
